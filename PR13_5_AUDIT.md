...
## 23. Limites de escopo

Este documento **não** implementa nenhuma recomendação. Não há mudança de gameplay, nem meleeRange/rangedRange, nem anti-repeat, nem balanceamento, nem alteração de versão, nem PR/merge.
