...
ok('F3 explicit Vector/Pyre and approved cast documentation',()=>{assert(s.includes('VECTOR  — atlético'));assert(s.includes('PYRE    — industrial'));assert(fs.existsSync(path.join(ROOT,'PR15_5_F3_FULL_OPERATOR_CAST.md')));});
